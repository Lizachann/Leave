...
{{--            dashboard--}}
            <a class=' w-full h-16 hover:bg-blue-900 rounded flex items-center' href="/home">
            ...
            <div class=" treeview menu-open ">
                ...
                <ul class="treeview-menu ">
                    <a class='w-full h-16 hover:bg-blue-900 rounded flex items-center' href='/admin/all/leave'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <a class='w-full h-16 hover:bg-blue-900 rounded flex items-center' href='/admin/pending/leave'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <a class='w-full h-16 hover:bg-blue-900 rounded flex items-center' href='/admin/approved/leave'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <a class='w-full h-16 hover:bg-blue-900 rounded flex items-center' href='/admin/rejected/leave'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div class=" treeview menu-open ">
                ...
                <ul class="treeview-menu ">
                    ...
                    <a class='w-full h-14 hover:bg-blue-900 rounded flex items-center' href='/admin/addStaff'>
