...
//        view own leave history
        ...
        // leave type
        route::get('/hod/leave/history/annual','history_annual_leave')->name('hod_history_annual');
        route::get('/hod/leave/history/medical','history_medical_leave')->name('hod_history_medical');
        route::get('/hod/leave/history/compensatory','history_compensatory_leave')->name('hod_history_compensatory');
        route::get('/hod/leave/history/maternity','history_maternity_leave')->name('hod_history_maternity');
